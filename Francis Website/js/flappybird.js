/**
 * THANKS FOR OVER 1900 UPVOTES AND THE OVER 2700 SPIN-OFFS!
 * 
 * Changelog:
 ...
 * - Added Sounds
 * - Flappy bird jumps a little higher and falls a little faster
 * - Added high scores
 * 
 * TODO: Add scores page
 * TODO: Re-code and fix the flappy bird freezing glitch
 * 
 **/
    ...
    /*if(typeof identifier === "string") {
        ...
        if(identifier % 1 === 0) {
            if(identifier < audio.length) {
                var audioObject = audio[identifier].object;
...
var FlappyBird = function() {
    ...
    this.controls = function() {
        if((mouseIsPressed || keys[32]) && !this.dead && this.descentSpeed >= 0) {
            this.descentSpeed = -7;
...
var die = function() {
    if(FlappiestBird.dead === false) {
        ...
        var highscore = getItem("highscore");
        highscore = max(highscore, score);
        
        setItem("highscore", highscore);
...
draw = function() {
    if(frameCount === 1) {
        ...
        precacheAudio(0, "Whoosh", "https://dl.dropboxusercontent.com/u/42058520/Flap%20Sound.ogg");
        precacheAudio(1, "Collect Coin", "https://dl.dropboxusercontent.com/u/42058520/SuperMarioBrothers-Coin.mp3");
        precacheAudio(2, "Punch", "https://dl.dropboxusercontent.com/u/42058520/Punch%20Sound%20Effect_-%5Bwww_flvto_com%5D.mp3");
    }
    ...
    if(gameState === 1 || gameState === 2) {
        ...
        while(index--) {
            ...
            if(abs(object.x - FlappiestBird.x) <= 1 && gameState === 1) {
                score++;
                playAudio(1);
            }
    ...
    if(gameState === 2) {
        ...
        if(FlappiestBird.y >= 325 && deathTicks >= 15) {
            ...
            text(score, 305, 200);
            text(getItem("highscore"), 305, 250);
        }
    }
};
